...
local workspace_dir = "~/repos/learning/java/springboot/" .. project_name
...
local config = {
  ...
  cmd = {
    -- 💀
    '/home/carlos/jdt-language-server/bin/jdtls', -- or '/path/to/java17_or_newer/bin/java'
    ...
    '-configuration', '/home/carlos/jdt-language-servercconfig_linux',
    ...
    java = {
      ...
      configuration = {
        runtimes = {
          {
            name = "JavaSE-17",
            path = "~/.asdf/installs/java/openjdk-17.0.1/",
            default = true
          },
        }
      },
